...
{
    [EventSource(Name = "MyCompany-TestSFA-EventProcessor")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        public static class Keywords
        {
            ...
            //public const EventKeywords Exceptions = (EventKeywords)0x8L;
        }
        #endregion
        ...
        private const int ErrorEventId = 25;
        [Event(ErrorEventId, Level = EventLevel.Error, Keywords = EventKeywords.None, Message = "{0}")]
